...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thu Thủy Trường Tiểu học Tiên Kiều Xã Hùng AN SĐTO 0394628499</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thu Thủy -  Trường TH Tiên Kiều xã Hùng An - ĐT: 0394682499</div>", unsafe_allow_html=True)
